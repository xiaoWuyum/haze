...
export const SONGS: Song[] = [
  ...
  },
  {
    ...
    genre: 'K-Pop / R&B',
    notes: '轻快、甜感、适合夜晚通勤和城市漫游的 K-Pop 歌单氛围。',
    duration: 179,
    audioUrl: '/audio/NewJeans+(뉴진스)-Hype+Boy.mp3',
  },
  {
    id: 'supernatural',
    title: 'Supernatural',
    ...
    notes: '复古律动和清爽人声，适合明亮、轻盈的播放场景。',
    duration: 191,
    audioUrl: '/audio/NewJeans+(뉴진스)-Supernatural.mp3',
  },
  {
    id: 'not_like_us',
    title: 'Not Like Us',
  ...
  },
  {
    ...
    genre: 'Mandopop / Acoustic',
    notes: '清爽、温柔、带一点海边午后的松弛感，适合华语歌单。',
    duration: 240,
    audioUrl: '/audio/刘瑞琦-夏天的风.mp3',
  },
  {
    id: 'xiaoban',
    title: '小半',
...
export const DEFAULT_SPACES: Space[] = [
  {
    ...
    description: '城市高空玻璃后的深夜雨景。窗外霓虹闪烁，房间内温暖安静，适合放空、夜读或失眠时停留。',
  },
  {
    id: 'kyoto_house',
    title: '京都木屋 黄昏',
  ...
  },
  {
    ...
    description: '一个人漂流在星云深处，看群星缓慢旋转，让念头在太空回声里散开。',
  },
  {
    id: 'seaside_cottage',
    title: '潮汐假期',
